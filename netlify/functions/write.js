...
exports.handler = async function (event) {
  ...
  const prompts = {
    general: `Answer this English-related question clearly and accurately, as a knowledgeable teacher would — it could be a grammar question, a general knowledge question, a question from a textbook, or a multiple-choice question. If it's multiple choice, state the correct option clearly and explain why. Give a complete, well-explained answer suitable for a student at ${gradeText}. Question: "${input}". Plain text only, no markdown symbols.`,
    grammarDeep: `Check this sentence for ANY problems — grammar, spelling, AND meaning-level issues that simple rule-checkers miss (like gender/pronoun mismatches, e.g. "he is a girl", or tense-time word mismatches, e.g. "I was there tomorrow"). Sentence: "${input}". If there are no issues at all, say so clearly. Otherwise, list each issue with a short explanation and the corrected sentence. Keep it appropriate for a student at ${gradeText}. Plain text only, no markdown symbols.`,
